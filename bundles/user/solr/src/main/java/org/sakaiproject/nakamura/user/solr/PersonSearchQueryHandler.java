...
@Component
@Properties({
    @Property(name = SearchConstants.REG_PROVIDER_NAMES, value="PersonSearchQueryHandler"),
    @Property(name = SearchConstants.REG_PROCESSOR_NAMES, value = "PersonSearchQueryHandler")
})
public class PersonSearchQueryHandler extends DomainObjectSearchQueryHandler {
  private static final Logger LOGGER = LoggerFactory.getLogger(PersonSearchQueryHandler.class);

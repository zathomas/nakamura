...
public class DocMigratorTest {
  ...
  @Test
  public void convert_an_old_structure() throws Exception {
    String structure = readFileAsString("/Users/zach/dev/nakamura/bundles/files/impl/src/main/resources/oldstructure.json");
    String requiresMigration = docMigrator.processStructure(structure);
    assertEquals(requiresMigration, "Hi there");
  }

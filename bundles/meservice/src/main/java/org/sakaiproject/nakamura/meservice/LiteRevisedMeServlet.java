...
public class LiteRevisedMeServlet extends SlingSafeMethodsServlet {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(LiteRevisedMeServlet.class);
   ...
   * @see {@link #doGet(org.apache.sling.api.SlingHttpServletRequest, org.apache.sling.api.SlingHttpServletResponse)}
   */
  ...
  private void getUncached(SlingHttpServletRequest request, SlingHttpServletResponse response)
    ...
    try {
      ...
      LOG.error("Failed to create proper JSON response in /system/me-revised", e);
      response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
          "Failed to create proper JSON response.");
    } catch (StorageClientException e) {
      LOG.error("Failed to get a user his profile node in /system/me-revised", e);
      response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
      ...
      LOG.error("Failed to get a user his message counts in /system/me-revised", e);
      response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
          "Messaging error.");
    } catch (SolrSearchException e) {
      LOG.error("Failed to execute a Solr search in /system/me-revised", e);
      response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR,
          "Solr search error.");
    }
  }
   ...
   * @param counts
   * @throws org.apache.sling.commons.json.JSONException
   * @throws org.sakaiproject.nakamura.api.search.solr.SolrSearchException
   */
   ...
   * @throws org.sakaiproject.nakamura.api.message.MessagingException
   * @throws org.sakaiproject.nakamura.api.search.solr.SolrSearchException
   */

...
class SamlAuthenticationTokenServiceWrapper extends TrustedTokenServiceWrapper {
  /**
   * @param delegate
   */
  SamlAuthenticationTokenServiceWrapper(SamlLoginServlet servlet,
   ...
   * @return
   */
  private static TrustedTokenService validate(SamlLoginServlet servlet, TrustedTokenService delegate) {
    if ( !SamlLoginServlet.class.equals(servlet.getClass()) ) {

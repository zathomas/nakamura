...
class RestAuthenticationTokenServiceWrapper extends TrustedTokenServiceWrapper {
  /**
   * @param delegate
   */
  RestAuthenticationTokenServiceWrapper(RestLoginServlet servlet,
   ...
   * @return
   */
  private static TrustedTokenService validate(RestLoginServlet servlet, TrustedTokenService delegate) {
    if ( !RestLoginServlet.class.equals(servlet.getClass()) ) {

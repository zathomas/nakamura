 ...
 * {@link RestLoginModulePlugin#getAuthentication(java.security.Principal, Credentials) to
 * be injected into the authentication cycle.
 */
public class RestAuthenticationPlugin implements AuthenticationPlugin {
  private RestLoginModulePlugin loginModulePlugin;

  public RestAuthenticationPlugin(RestLoginModulePlugin loginModulePlugin) {

...
public class RestAuthenticationHandlerTest {
  RestAuthenticationHandler ssoAuthenticationHandler;
  ...
  public void setUp() throws Exception {
    ...
    ssoAuthenticationHandler = new RestAuthenticationHandler(repository,
  ...
  public void coverageBooster() throws Exception {
    RestAuthenticationHandler handler = new RestAuthenticationHandler();
  ...
  public void extractCredentialsNoAssertion() throws Exception {
    ...
    verify(request, never()).setAttribute(eq(RestAuthenticationHandler.AUTHN_INFO),
  ...
  public void extractCredentialsFromAssertion() throws Exception {
    ...
    verify(request).setAttribute(eq(RestAuthenticationHandler.AUTHN_INFO),
        isA(AuthenticationInfo.class));
  }
  ...
  private void setUpSsoCredentials() throws Exception {
    ...
    cookies[1] = new Cookie(RestAuthenticationHandler.DEFAULT_ARTIFACT_NAME, ARTIFACT);
  ...
  private void setupValidateHandler() throws Exception {
    ...
    props.put(RestAuthenticationHandler.SERVER_URL, url);
    ...
    server.register("/sso/identity/isTokenValid", new HttpRequestHandler() {
      ...
      public void handle(HttpRequest request, HttpResponse response, HttpContext context)
        ...
        response.setEntity(new StringEntity(
            RestAuthenticationHandler.DEFAULT_SUCCESSFUL_BODY));
      }
    });
    ...
    server.register("/sso/identity/attributes", new HttpRequestHandler() {
      ...
      public void handle(HttpRequest request, HttpResponse response, HttpContext context)
        ...
        String output = "Random Opening Line That Shouldn't Matter\n"
            + RestAuthenticationHandler.USRDTLS_ATTR_NAME_STUB
            + RestAuthenticationHandler.DEFAULT_ATTRIBUTE_NAME + "\n"
            + RestAuthenticationHandler.USRDTLS_ATTR_VAL_STUB + "someUserId";
  ...
  private void setAutocreateUser(boolean bool) {
    props.put(RestAuthenticationHandler.REST_AUTOCREATE_USER, bool);
    ssoAuthenticationHandler.modified(props);
  }
}

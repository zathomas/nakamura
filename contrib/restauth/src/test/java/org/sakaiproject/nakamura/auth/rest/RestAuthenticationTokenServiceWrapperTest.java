...
public class RestAuthenticationTokenServiceWrapperTest {
  ...
  @Mock
  RestLoginServlet mockedServlet;
  ...
  RestAuthenticationTokenServiceWrapper wrapper;

  @Before
  public void setUp() throws Exception {
    servlet = new RestLoginServlet();
  ...
  public void validateFailure() throws Exception {
    wrapper = new RestAuthenticationTokenServiceWrapper(mockedServlet, delegate);
  }

  @Test
  public void validateSuccess() {
    wrapper = new RestAuthenticationTokenServiceWrapper(servlet, delegate);
  }
